...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32632',
            extent: [768086.337681, 412007.412786, 786143.135521, 445224.505390],
            units: 'm'})
    })
});
...
map.getView().fit([779853.745920, 427527.692758, 780154.239726, 427699.634796], map.getSize());
